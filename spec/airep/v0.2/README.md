...
| [`schema-design/`](./schema-design/) | Artifact-schema phase Stage 1: the **schema design contract** for the four artifact families (common wire shape, field decision matrix, closure discipline, open design questions). DESIGN — no `.schema.json` exists yet. |
