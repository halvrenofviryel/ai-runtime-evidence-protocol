...
| 9 | Class ladder named Core / Verified / Trusted; "Trusted" reachable only in opt-in strict mode | Ladder renamed (**decided**: AIREP-Core / AIREP-Authenticated / AIREP-Witnessed); Core claims "structurally valid and internally hash-consistent" (not "untampered"); every class bound to "provenance, integrity, freshness — not truth" | AD-09 | **VOCAB** |
