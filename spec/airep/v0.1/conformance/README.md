...
- [`enas_profiles.py`](./enas_profiles.py) — validates thirty experimental,
  ...
  cross-field and typed-graph rules. Its four corpora contain 115 cases: thirty-three
  expected passes and eighty-two expected rejections. The bundle validators
...
- [`test_enas_profiles.py`](./test_enas_profiles.py) — pins the four fixture-corpus
  outcomes (115 cases) against their expected pass/reject labels.
