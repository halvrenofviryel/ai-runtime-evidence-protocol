...
- [`enas_profiles.py`](./enas_profiles.py) — validates thirty experimental,
  standalone ENAS evidence contracts against Draft 2020-12 schemas and bounded
  cross-field and typed-graph rules. Its four corpora contain 126 cases: thirty-eight
  expected passes and eighty-eight expected rejections. The bundle validators
...
- [`test_enas_profiles.py`](./test_enas_profiles.py) — pins the four fixture-corpus
  outcomes (126 cases) against their expected pass/reject labels.
