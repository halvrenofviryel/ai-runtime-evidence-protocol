# HERMES-AIREP-11 — same-executor effect observation

This directory is a deterministic synthetic mapping fixture, not a captured production Hermes run.

- Artifact families: control x2, decision x1, effect x1, execution x1
...
|---|---|
| `artifact_admission` | `SATISFIED, SATISFIED, SATISFIED, SATISFIED, SATISFIED` |
| `record_authentication` | `SATISFIED, SATISFIED, SATISFIED, SATISFIED, SATISFIED` |
| `chain_link` | `SATISFIED, SATISFIED, SATISFIED, SATISFIED, SATISFIED` |
