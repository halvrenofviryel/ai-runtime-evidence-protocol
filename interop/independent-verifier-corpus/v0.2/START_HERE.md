...
```sh
sha256sum airep-v0.2-independent-verifier-corpus-v0.2-full.zip
```
...
```sh
unzip airep-v0.2-independent-verifier-corpus-v0.2-full.zip
cd airep-v0.2-independent-verifier-corpus-v0.2
```
